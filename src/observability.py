...
rfc_chains_started_total = Counter(
    "rfc_chains_started_total",
    "Total number of RFC chains initiated",
)

rfc_chains_submitted_total = Counter(
    "rfc_chains_submitted_total",
    "Total number of RFCs submitted for execution",
)

rfc_chains_rejected_total = Counter(
    "rfc_chains_rejected_total",
    "Total number of RFCs rejected at the approval step",
)
