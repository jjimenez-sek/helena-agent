...
from .auth.keycloak import get_current_user, scoped_thread_id
    ...
    try:
        async for chunk in compiled_graph.astream(
            ...
            if chunk_type == "custom":
                ...
                if event_kind == "token":
                ...
                elif event_kind == "closed_questions":
                    yield _sse_event({
                        "type": "closed_questions",
                        "questions": event_data.get("questions", []),
                    })

                elif event_kind == "rfc_step_progress":
                    yield _sse_event({
                        "type": "rfc_step_progress",
                        "step": event_data.get("step"),
                        "total_open_steps": event_data.get("total_open_steps"),
                    ...
                    yield _sse_event({
                        ...
                        "workflows": event_data.get("workflows", []),
                        "rfc_data": event_data.get("rfc_data", {}),
                    })
...
async def chat_stream(
    ...
    # Derive workflow list from WORKFLOW-type project steps (on-demand context)
    project_workflows = [
        {
